"""
Django settings for crisis_relief project.
...
SECRET_KEY = 'django-insecure-f)0^$n1$0(-+tinw*doeap!00%utm7swh6yj-0c5m$=3llk_mx'
...
WSGI_APPLICATION = 'crisis_relief.wsgi.application'
...
MARKDOWNIFY = {
    "default": {
        "WHITELIST_TAGS": [
            ...
            'ul', 'ol', 'li', 'strong', 'em', 'input'
        ],
        "WHITELIST_ATTRS": [
            'href', 'src', 'alt', 'class', 'checked', 'type'
        ],
        "MARKDOWN_EXTENSIONS": [
